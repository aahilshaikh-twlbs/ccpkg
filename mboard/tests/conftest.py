...
def tmp_home(monkeypatch, tmp_path):
    ...
    # Ensure spawned subprocesses (e.g. the daemon) can find the mboard package.
    # The stdlib has a 'mboard' module that shadows ours unless src/ is first on PYTHONPATH.
